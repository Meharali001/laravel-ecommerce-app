        ...
        <div class="card">
          <div class="card-body p-4">
            <div class="row">
              <div class="col-lg-7">
                <h5 class="mb-3">
                  <a href="{{ route('user.ShopNow') }}" class="text-body"><i class="fas fa-long-arrow-alt-left me-2"></i>Continue shopping</a>
                </h5>
                <hr>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    <h5>{{ $item['name'] }}</h5>
                                    {{-- <p class="small mb-0">{{ $item['color'] }}</p> --}}
                                </div>
                            </div>
                            <div class="d-flex align-items-center">
                                <h5 class="fw-normal mb-0 mx-3">{{ $item['qty'] ?? '_' }}</h5>
            ...
            @endforeach
                  ...
                  <!-- Total Price -->
                  <div class="text-end">
                    <h4>Total: ${{ number_format(collect($cartitem)->sum(fn($item) => $item['price'] * $item['qty']), 2) }}</h4>
                  </div>
                @endif
              </div>
              ...
              <div class="col-lg-5">
                <form id="payment-form" class="mt-4">
                  ...
                  <button type="submit" id="submit" class="btn btn-primary w-100 {{ empty($cartitem) ? 'disabled' : '' }}">Pay Now</button>
                </form>
              </div>
            </div>              
          </div>
